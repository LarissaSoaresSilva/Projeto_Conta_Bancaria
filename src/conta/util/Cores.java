...
public class Cores {
	                ...
	                //Reset Color- voltar ao padrão
			public static final String TEXT_RESET = "\u001B[0m";

			//Text Color - alterar cor do texto 
			...
			//Text Color Bold - alterar a cor e deixar o texto em negrito
			...
			//Reset Text Underline - alterar texto e sublinhar
			...
			// Text Color High Intensity - cor mais clara 
			...
			// Text Color Bold High Intensity- cor mais clara e negrito
			...
			// Background Color - alterar plano de fundo
			...
			// Background Color High Intensity - plano de fundo mais claro e em negrito
